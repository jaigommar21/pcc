	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="col-md-6">
				...
				<hr>
				<form:form method="post" servletRelativeAction="/admin/emp/delete"
					...
					--%>
					<div class="form-group">
						<input type="submit" value="Delete" class="btn btn-success" /> <a
							href="<%=request.getContextPath()%>/admin/emp/list"
